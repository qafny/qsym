...
method conditionaltest4(n: nat, N: nat, amp: seq<seq<real>>, q: seq<seq<seq<bv1>>>, p: seq<seq<seq<bv1>>>, r1: seq<bv1>, u2: seq<bv1>) returns (amp8: seq<seq<seq<real>>>, q8: seq<seq<seq<seq<bv1>>>>, p8: seq<seq<seq<seq<bv1>>>>, u8: seq<seq<seq<seq<bv1>>>>, r8: seq<seq<seq<seq<bv1>>>>)
  requires n > 0
  requires |q| == pow2(n)
  ...
  ensures forall k :: 0 <= k < pow2(n) ==> forall j :: 0 <= j < pow2(n) ==> forall t :: 0 <= t < pow2(1) ==> amp8[k][j][t] == if j < N then ((1.0 / (pow2(n) as real)) * (1.0 / sqrt((pow2(1) as real)))) else (1.0 / (pow2(n) as real))  
  ensures forall k :: 0 <= k < pow2(n) ==> forall j :: 0 <= j < pow2(n) ==> forall t :: 0 <= t < pow2(1) ==> castBVInt(q8[k][j][t]) == k
  ensures forall k :: 0 <= k < pow2(n) ==> forall j :: 0 <= j < pow2(n) ==> forall t :: 0 <= t < pow2(1) ==> castBVInt(p8[k][j][t]) == j
  ensures forall k :: 0 <= k < pow2(n) ==> forall j :: 0 <= j < pow2(n) ==> forall t :: 0 <= t < pow2(1) ==> castBVInt(u8[k][j][t]) == if j < N then 1 else 0
  ensures forall k :: 0 <= k < pow2(n) ==> forall j :: 0 <= j < pow2(n) ==> forall t :: 0 <= t < pow2(1) ==> castBVInt(r8[k][j][t]) == if j < N then t else 0
{
  var q6 := q;
  var p6 := p;
  var amp6 := amp;
  ...
  invariant forall tmp8 :: 0 <= tmp8 < |q7| ==> forall tmp9 :: 0 <= tmp9 < |q7[tmp8]| ==> forall tmp10 :: 0 <= tmp10 < |q7[tmp8][tmp9]| ==> castBVInt(q7[tmp8][tmp9][tmp10]) == if castBVInt(p6[tmp8][tmp9]) < N then castBVInt(q6[tmp8][tmp9]) else castBVInt(q6[tmp8][tmp9])
  invariant forall tmp8 :: 0 <= tmp8 < |p7| ==> forall tmp9 :: 0 <= tmp9 < |p7[tmp8]| ==> forall tmp10 :: 0 <= tmp10 < |p7[tmp8][tmp9]| ==> castBVInt(p7[tmp8][tmp9][tmp10]) == if castBVInt(p6[tmp8][tmp9]) < N then castBVInt(p6[tmp8][tmp9]) else castBVInt(p6[tmp8][tmp9])
  invariant forall tmp8 :: 0 <= tmp8 < |u7| ==> forall tmp9 :: 0 <= tmp9 < |u7[tmp8]| ==> forall tmp10 :: 0 <= tmp10 < |u7[tmp8][tmp9]| ==> castBVInt(u7[tmp8][tmp9][tmp10]) == if castBVInt(p6[tmp8][tmp9]) < N then 1 else castBVInt(u6[tmp8][tmp9])
  invariant forall tmp8 :: 0 <= tmp8 < |r7| ==> forall tmp9 :: 0 <= tmp9 < |r7[tmp8]| ==> forall tmp10 :: 0 <= tmp10 < |r7[tmp8][tmp9]| ==> castBVInt(r7[tmp8][tmp9][tmp10]) == if castBVInt(p6[tmp8][tmp9]) < N then tmp10 else castBVInt(r6[tmp8][tmp9])
  invariant forall tmp8 :: 0 <= tmp8 < |amp7| ==> forall tmp9 :: 0 <= tmp9 < |amp7[tmp8]| ==> forall tmp10 :: 0 <= tmp10 < |amp7[tmp8][tmp9]| ==> amp7[tmp8][tmp9][tmp10] == if castBVInt(p6[tmp8][tmp9]) < N then (amp6[tmp8][tmp9] * ((1.0 / sqrt((pow2(|r7[tmp8][tmp9][tmp10]|) as real))) * omega(castBVInt(r6[tmp8][tmp9]), 2))) else amp6[tmp8][tmp9]
  invariant forall tmp8 :: 0 <= tmp8 < |p7| ==> forall tmp9 :: 0 <= tmp9 < |p7[tmp8]| ==> forall tmp10 :: 0 <= tmp10 < |p7[tmp8][tmp9]| ==> samebit(p7[tmp8][tmp9][tmp10], p6[tmp8][tmp9], |p6[tmp8][tmp9]|)
{
  var tmp1q := [];
  var tmp1p := [];
  var tmp1u := [];
  ...
  invariant forall tmp8 :: 0 <= tmp8 < |tmp1q| ==> forall tmp9 :: 0 <= tmp9 < |tmp1q[tmp8]| ==> castBVInt(tmp1q[tmp8][tmp9]) == if castBVInt(p6[tmp][tmp8]) < N then castBVInt(q6[tmp][tmp8]) else castBVInt(q6[tmp][tmp8])
  invariant forall tmp8 :: 0 <= tmp8 < |tmp1p| ==> forall tmp9 :: 0 <= tmp9 < |tmp1p[tmp8]| ==> castBVInt(tmp1p[tmp8][tmp9]) == if castBVInt(p6[tmp][tmp8]) < N then castBVInt(p6[tmp][tmp8]) else castBVInt(p6[tmp][tmp8])
  invariant forall tmp8 :: 0 <= tmp8 < |tmp1u| ==> forall tmp9 :: 0 <= tmp9 < |tmp1u[tmp8]| ==> castBVInt(tmp1u[tmp8][tmp9]) == if castBVInt(p6[tmp][tmp8]) < N then 1 else castBVInt(u6[tmp][tmp8])
  invariant forall tmp8 :: 0 <= tmp8 < |tmp1r| ==> forall tmp9 :: 0 <= tmp9 < |tmp1r[tmp8]| ==> castBVInt(tmp1r[tmp8][tmp9]) == if castBVInt(p6[tmp][tmp8]) < N then tmp9 else castBVInt(r6[tmp][tmp8])
  invariant forall tmp8 :: 0 <= tmp8 < |tmp1amp| ==> forall tmp9 :: 0 <= tmp9 < |tmp1amp[tmp8]| ==> tmp1amp[tmp8][tmp9] == if castBVInt(p6[tmp][tmp8]) < N then (amp6[tmp][tmp8] * ((1.0 / sqrt((pow2(|tmp1r[tmp8][tmp9]|) as real))) * omega(castBVInt(r6[tmp][tmp8]), 2))) else amp6[tmp][tmp8]
  invariant forall tmp8 :: 0 <= tmp8 < |tmp1p| ==> forall tmp9 :: 0 <= tmp9 < |tmp1p[tmp8]| ==> samebit(tmp1p[tmp8][tmp9], p6[tmp][tmp8], |p6[tmp][tmp8]|)
{
  var res := bool2BV1(castBVInt(p6[tmp][tmp1]) < N);
