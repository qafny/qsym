...
def shors_circuit(a: int, N_COUNT: int):
    ...
    for q in range(N_COUNT):
        ...
        qc.append(StateAssertion(assertion_str, range(N_COUNT)), range(N_COUNT))
...
cc = shors_circuit(7, 15)
cc = cc.decompose()
#print(cc.draw())

real_qc0 = transpile(cc, basis_gates=['rz', 'ry', 'rx', 'cx', 'ccx', 'x', 'h'], optimization_level=3)
